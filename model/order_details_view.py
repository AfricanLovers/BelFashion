...
class OrderDetailsView(QMainWindow, Ui_OrderDetails):
    ...
    def load_order_details(self):
        ...
        for item in db.get_order_items_by_order_id(self.order_id):
            ...
            quantity = item[3]
            clothes_card = OrderDetailsClothesCard(clothes[0], clothes[2], clothes[3], db.get_category_name(clothes[1]), clothes[4], clothes[7], clothes[6], quantity, self.main_window, parent_window=self)
